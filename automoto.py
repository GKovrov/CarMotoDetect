...
while True:
    ...
    results = model(source=crop_frame, conf=0.45, iou=0.5, show=False, save=False, verbose=False, classes=[2,3])
    ...
    resize_frame = cv2.resize(frame, dsize=(int(frame_height/2), int(frame_width/2)), interpolation=cv2.INTER_CUBIC) 
